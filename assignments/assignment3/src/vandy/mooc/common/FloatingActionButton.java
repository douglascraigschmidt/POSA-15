...
public class FloatingActionButton 
    ...
    /**
     * Constructor that initializes the Floating Action Button.
     * 
     * @param context
     */
	public FloatingActionButton(Context context,
        ...
        this.color = a.getColor(R.styleable.FabView_fabColor,
                                Color.WHITE);
        this.drawable =
            a.getDrawable(R.styleable.FabView_fabDrawable);
        this.mBitmap =
