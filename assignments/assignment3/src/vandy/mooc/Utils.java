...
public class Utils {
    ...
    public static Uri grayScaleFilter(Context context,
        ...
        grayScaleImage = convertToGreyScale(grayScaleImage);
    ...
    private static ScriptC_ConvertToGreyScaleKernel greyscale=null;

    public static void prepareRS(RenderScript rs) {
        renderScript = rs;
        greyscale = new ScriptC_ConvertToGreyScaleKernel(Utils.renderScript);
    }

    public static Bitmap convertToGreyScaleRS(Bitmap grayScaleImage) {

        int width = grayScaleImage.getWidth();
        int height = grayScaleImage.getHeight();
        Bitmap.Config config = grayScaleImage.getConfig();

        Bitmap output = Bitmap.createBitmap(width, height, config);

        Allocation inputAllocation = Allocation.createFromBitmap(renderScript, grayScaleImage, Allocation.MipmapControl.MIPMAP_NONE, Allocation.USAGE_SHARED | Allocation.USAGE_GRAPHICS_TEXTURE | Allocation.USAGE_SCRIPT);
        ...
        // Run Kernel
        greyscale.forEach_grayscale(inputAllocation, outputAllocation);
    ...
    public static Bitmap convertToGreyScale(Bitmap grayScaleImage) {
