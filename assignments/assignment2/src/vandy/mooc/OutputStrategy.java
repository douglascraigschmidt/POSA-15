...
/**
 * Implements a API for outputting data to Android UI thread and synchronizing on thread completion in the ping-pong
 * application.
 */
public class OutputStrategy {
	/**
	 * Define a WeakReference to avoid memory leaks. See
	 * www.androiddesignpatterns.com/2013/01/inner-class-handler-memory-leak.html for an explanation of why we need this
	 * WeakReference.
	 */
	...
	/**
	 * Output the string from a background thread to the Android display managed by the UI thread.
	 */
