...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == DOWNLOAD_IMAGE_REQUEST) {
            	...
            	if(imageUri != null) {
	            	Intent galeryIntent = makeGalleryIntent(imageUri.toString());
	            	startActivity(galeryIntent);
            	} else {
            		Toast.makeText(this, "Invalid url content", Toast.LENGTH_LONG).show();
            	}
        ...
        // code.
        	...
        	Toast.makeText(this, "Image file wasn't downloaded", Toast.LENGTH_LONG).show();
        }
    }    
    ...
    protected Uri getUrl() {
        ...
        if (url.toString().matches("^(https?:\\/\\/)?([\\da-z\\.-]+)\\.([a-z\\.]{2,6})([\\/\\w \\.-]*)*\\/?$")){
