...
/**
 * This class uses synchronous AIDL interactions to expand acronyms
 * via an Acronym Web service.  The AcronymModel that binds to this
 * Service will receive an IBinder that's an instance of AcronymCall,
 * which extends IBinder.  The AcronymModel can then interact with
 * this Service by making two-way method calls on the AcronymCall
 * object asking this Service to lookup the meaning of the Acronym
 * string.  After the lookup is finished, this Service sends the
 * Acronym results back to the AcronymModel by returning a List of
 * AcronymData.
 * 
